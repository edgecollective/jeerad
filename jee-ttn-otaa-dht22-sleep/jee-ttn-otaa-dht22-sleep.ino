...
const unsigned TX_INTERVAL = 48;

int sleepcycles = TX_INTERVAL / 8;  // each sleep cycle is 8S
...
void do_send(osjob_t* j){
  ...
  float temperature = dht_a.readTemperature(true);
...
void setup() {
    ...
    dht_a.begin(); // start the DHT sensor
